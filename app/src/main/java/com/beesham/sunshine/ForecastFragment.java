...
public class ForecastFragment extends Fragment {
    ...
    private ArrayAdapter<String> forcastArrayAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        forecastDataStr = forecastData.getData();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forcastArrayAdapter = new ArrayAdapter<String>(getActivity(), R.layout.list_item_forcast, R.id.list_item_forcast_textview, forcastAL);
        forcastLV = (ListView) rootView.findViewById(R.id.listView_forcast);
        forcastLV.setAdapter(forcastArrayAdapter);
