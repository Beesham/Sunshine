...
public class Utility {
    ...
    */
    ...
    public static boolean isOnline(Context context) {
        Log.v("isOnline", "calling isOnline");
    ...
    /**
     * Get the location status from the prefernce file
     * @param context
     * @return
     */
    ...
    /**
     * Resets the loaction status to default
     * @param context
     */
    ...
    public static void setLocationStatusToInvalid(Context context){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(context.getString(R.string.pref_location_status_key), SunshineSyncAdapter.LOCATION_STATUS_INVALID)
                .commit();
    }
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        String formatArtUrl = preferences.getString(context.getString(R.string.pref_art_pack_key),
                context.getString(R.string.pref_art_pack_label_sunshine));
    ...
    * @return string for the weather condition. null if no relation is found.
    ...
    /**
     * Checks if a keys exists for latitude and longitude
     * @param context
     * @return
     */
    public static boolean isLocationsLatLonAvailable(Context context){
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
