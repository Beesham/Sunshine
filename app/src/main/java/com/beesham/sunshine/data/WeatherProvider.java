 ...
 */
package com.beesham.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int update(
        ...
        switch(match){
            case LOCATION:
                rowsUpdated = sqLiteDatabase.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            case WEATHER:
                rowsUpdated = sqLiteDatabase.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
