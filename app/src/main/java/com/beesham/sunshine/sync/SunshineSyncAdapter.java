package com.beesham.sunshine.sync;
...
import com.beesham.sunshine.BuildConfig;
import com.beesham.sunshine.MainActivity;
import com.beesham.sunshine.R;
import com.beesham.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            if(Utility.isLocationsLatLonAvailable(context)){
        ...
        if(displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    FutureTarget<Bitmap> largeIconFutureTarget;
                    Bitmap largeIcon;
                    try{
                        largeIconFutureTarget = Glide.with(context)
                                .load(artUrl)
                                .asBitmap()
                                .error(artResourceId)
                                .fitCenter()
                        ...
                        largeIcon = largeIconFutureTarget.get();
